...
Require-Regex $uiSource 'static\s+const\s+uint8_t\s+glyph_w\[5\]' 'W glyph for white'
Require-Regex $uiSource 'static\s+const\s+uint8_t\s+glyph_h\[5\]' 'H glyph for white'
